...
import logging
import ctypes
from hw_collector import collect_all_info

# 解决 Windows 下 Tkinter 界面模糊及 DPI 缩放突然变化的问题
try:
...
class App(tk.Tk):
    ...
    def create_widgets(self):
        ...
        # 提交按钮
        self.btn_submit = tk.Button(self, text="提 交 信 息", bg="#0078D7", fg="white", font=("Microsoft YaHei", 14, "bold"), command=self.submit_data)
